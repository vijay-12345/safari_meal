	...
	<ul>
		...
		<li class="dropdown keep-open <?php if(in_array(Request::segment(3),['restaurant','coupon','review'])) echo 'open'; ?>">
			...
			<ul class="dropdown-menu">
				<li><a href="<?php echo url('admin/restaurant'); ?>">{{trans('admin.restaurant.details')}}
					<!-- <span class="flaticon-arrows-1"></span> -->
				</a></li>
		...
		<li class="dropdown keep-open <?php if(in_array(Request::segment(3),['cuisine','menu'])) echo 'open'; ?>">
