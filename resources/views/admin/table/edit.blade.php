...
@section('title', trans('admin.edit.table'))
@section('content')
<?php 
			...
			<div class="col-md-9">
				<div class="page-data-right">
					<div class="panel panel-default">
						<div class="panel-heading text-center">{{trans('admin.edit.table')}}</div>
						<div class="panel-body">
							...
							$order=$data['order'];
							?>
							 {!! Form::model($data['order'], ['method' => 'post','role' => 'form','class'=>'form-horizontal','url' => $prefix.'/table/update'.'/'.$data['order']->id]) !!}	
							  	<br />	
						    	...
						    	<div class="form-group">
							      ...
							      <div class="col-md-10">
							      	<?php echo view('admin.table.ajaxcustomer',['customer'=>$customer,'order'=>$order,'action'=>'orderview'])->render();	?>
							      </div>
							      @endif							      
						    	</div>
											...
											<div class="page-data-right">
												<div class="panel panel-default">
													<div class="panel-heading text-center">{{trans('admin.order.view')}}</div>
														<div class="panel-body">	
															 <?php echo view('admin.table.view',['orderdetails'=>$orderdetails, 'order' => $order])->render();	?>
														</div>
													</div>
												</div>
											</div>	
						    	...
						    	<div class="row">
						    		<div class="col-sm-12">
						    			...
						    			@else
						    				<a href="{{url($prefix.'/table')}}" class="btn btn-primary">{{trans('admin.back')}}</a>&nbsp;
						    			@endif						  							  						  
