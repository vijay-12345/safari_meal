				...
				<div class="page-data-right">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							@endif
							@if(!isset($user))																	
							{!! Form::open(['class'=>'form-horizontal','url' => $prefix.'/homecooked/access/'.$restaurantObj->id]) !!}	
							@else
							{!! Form::model($user, ['method' => 'post','role' => 'form','class'=>'form-horizontal','url' => $prefix.'/homecooked/access/'.$restaurantObj->id]) !!}	
							@endif
							<br />
