							...
							<tr>																
								<div class="single-restro">
									<div class="restro-list-data">	
										...
										?>
										<a href="{{url('/restaurentdetail/'.$restaurentdetail['restaurent_urlalias'] . '?location=' . $location)}}" title="" class="restro-menu-btn btn btn-primary">{{Lang::get('home.Go.to.Menu')}}</a>
									</div>
								</div><!--/single restro-->					
						<?php }
