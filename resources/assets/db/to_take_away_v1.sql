...
INSERT INTO `cuisine` (`id`, `name`, `lang_id`) VALUES
(1, 'pizza', 1),
(2, 'salds', 1),
(3, 'sandwiches', 1),
(4, 'seafood', 1),
...
INSERT INTO `image` (`id`, `type`, `target_id`, `location`) VALUES
(1, 'restaurant', 1, 'restro-thumb.png');
...
INSERT INTO `user` (`id`, `type`, `first_name`, `email`, `contact_number`, `verified`, `password`, `status`, `floor`, `street`, `company`, `remember_token`, `token`, `area`, `city`, `created_at`, `updated_at`, `last_name`, `login_type`, `countrycode`, `newsletter`) VALUES
(1, NULL, 'Bhuvnesh', 'bhuvnesh.pratap@enukesoftware.com', '+91-941128', NULL, '$2y$10$4M32jUIb1ngrYqwTV87YcOqM2EhdZmHFnoujwmBFGY6xZwRbqdaG.', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2016-05-10 01:09:27', '2016-05-10 01:09:27', 'Chaudhary', 'register', 0, 0);
