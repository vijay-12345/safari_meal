...
class RestaurentController extends Controller
{
	...
	*/
	...
	public function restaurentList($restaurantUrl = "")
	{
		...
		if( isset( $inputs['is_restaurant'] ) && $inputs['is_restaurant'] == 1 && !isset( $inputs['home_cooked'] )) $restaurent_query->where('restaurant.is_home_cooked', 0);

		if( isset( $inputs['home_cooked'] ) && $inputs['home_cooked'] == 1 && !isset( $inputs['is_restaurant'] )) $restaurent_query->where('restaurant.is_home_cooked', 1);

		if( isset( $inputs['is_restaurant'] ) && isset( $inputs['home_cooked'] ) && $inputs['home_cooked'] == 1 && $inputs['is_restaurant'] ==1 ) $restaurent_query->where(function ($query) { $query->where('restaurant.is_home_cooked', 1)->orWhere('restaurant.is_home_cooked', 0);});
