...
class HomeCookedReviewController extends \App\Http\Controllers\Controller {
	...
	*/
		...
		*/		
		...
		if($request->has('paginate_limit')){
			...
			if($request->input('search'))
				...
				{
					$data = null;
					return view('admin.homecookedreview.index',['data'=>$data,'filter'=>$filter]);
				}
	...
	public function add(Request $request){
		...
		return view('admin.homecookedreview.add');
	}
	public function edit($id){		
    	...
    	return view('admin.homecookedreview.edit')->withReview($review);
	...
	public function delete($id,Request $request){
		...
		return redirect($request->segment(2).'/homecookedreview');
	}	
