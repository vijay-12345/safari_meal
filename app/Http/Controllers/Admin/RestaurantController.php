...
class RestaurantController extends \App\Http\Controllers\Controller 
{
	...
	*/
	 ...
	 * @return Response
	 */
	public function restindex(Request $request)
	{		
	    DB::enableQueryLog(); 
		...
		*/	
		...
		$data = [];
		$q = Restaurent::lang()->select('restaurant.*','image.location','image.logo_location')
		->leftJoin('image', 'restaurant.id', '=', 'image.target_id')
