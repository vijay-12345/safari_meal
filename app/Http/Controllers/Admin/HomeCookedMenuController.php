...
class HomeCookedMenuController extends \App\Http\Controllers\Controller {
	...
	*/
		...
		*/	
		...
		if($request->has('paginate_limit')){
			...
			if($request->input('search'))
				...
				{
					$data = null;
					return view('admin.homecookedmenu.index',['data'=>$data,'filter'=>$filter]);
				}
	...
	public function add(Request $request){
		...
		return view('admin.homecookedmenu.add',['data'=>$data]);
	}
	public function edit($id){
    	$menu = Menu::findOrFail($id);
    	//prd($menu);
    	return view('admin.homecookedmenu.edit')->withMenu($menu);
	...
	public function delete($id){
		...
		return redirect('admin/homecookedmenu');
	}	
