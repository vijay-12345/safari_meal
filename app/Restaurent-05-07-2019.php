...
class Restaurent extends AppModel
{
	use SoftDeletes;
	...
	public $fillable = ["id","parent_id" ,"area_id","city_id","state_id","country_id","owner_id", "lang_id","deals", "name" ,"rating" ,"min_order","delivery_charge","delivery_time", "longitude" ,"latitude" ,"tax_per_order" ,"floor","street" ,"company" ,"status" ,"created_at" ,"updated_at","restaurent_urlalias","featured", 'admin_commission', 'is_veg', 'is_nonveg', 'phone', 'packaging_fees', 'cgst', 'sgst', "delivery_applicable", 'flat_delivery_time', 'confirm_order' ];
